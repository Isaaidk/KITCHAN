...
from src.kitchan.modules.usuarios.infrastructure.repository import PostgresUsuarioRepository
...
async def crear_usuario(request: CrearUsuarioRequest, db: AsyncSession = Depends(get_db)):
